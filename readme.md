# CodeSights Dataset Analysis & Insights

This repository contains data analysis scripts, exploratory data analyses (EDA), and insight reports built around datasets featured on [CodeSights](https://codesights.com/datasets). 

The goal of this project is to delve into unique datasets—ranging from historical battles and city growth trends to box office statistics and aviation safety—and extract meaningful, data-driven stories and insights to be published on the CodeSights website.

---

## 📁 Repository Structure

Each top-level directory in this repository corresponds to a specific dataset from CodeSights. Inside each folder, you will find the code, visualizations, and documentation behind the analysis.

```text
.
├── Academy-Award-Films/
│   ├── analysis.ipynb / script.py
│   └── README.md (findings & insight summary)
